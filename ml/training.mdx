...
<CardGroup cols={2}>
  ...
  <Card title="Feature Engineering Deep Dive" icon="wrench" href="/ml/features">
    Advanced feature customization
  </Card>
  <Card title="Performance Tuning" icon="gauge" href="/ml/optimization">
    Optimize model accuracy and speed
  </Card>
</CardGroup>